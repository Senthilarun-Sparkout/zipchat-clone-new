...
public class TextEditorDialogFragment extends DialogFragment {
    ...
    private VerticalSlideColorPicker colorPickerViewDialog;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        colorPickerViewDialog.setOnColorChangeListener(new VerticalSlideColorPicker.OnColorChangeListener() {
            @Override
